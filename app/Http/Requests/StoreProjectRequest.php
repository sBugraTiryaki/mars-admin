...
class StoreProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'rental_guarantee_rate' => ['nullable', 'numeric', 'min:0', 'max:100', 'required_if:has_rental_guarantee,true'],
            'has_buyback_guarantee' => ['nullable', 'boolean'],
            'buyback_guarantee_rate' => ['nullable', 'numeric', 'min:0', 'max:100', 'required_if:has_buyback_guarantee,true'],
